...
export default function Tracking({ appointment, activities }) {
    ...
    return (
        <>
                                    ...
                                    <div className="text-center">
                                        ...
                                        onClick={() => setShowCancelModal(true)}
                                            ...
                                            >
                                                ...
                                                {isCanceling ? 'Annulation en cours...' : 'Annuler ce rendez-vous'}
                                            </button>
                                        </div>
                                        <p className="text-xs text-gray-500 mt-3">
                                            ⚠️ Cette action est irréversible. Votre rendez-vous sera définitivement annulé.
                                        </p>
                                    </div>
                                </div>
                            )}

                            {appointment.status !== 'accepted' && appointment.status !== 'canceled' && appointment.status !== 'canceled_by_requester' && (
                                <div className="mt-6 pt-6 border-t border-gray-200">
                                    <div className="text-center">
            ...
            <Modal show={showCancelModal} onClose={() => !isCanceling && setShowCancelModal(false)} maxWidth="md">
                <div className="p-6">
                    <div className="text-center">
                    ...
                    <p className="text-sm text-gray-600 mb-6">
                        ...
                        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-6">
                            ...
                            <div className="text-sm text-yellow-800 space-y-1">
                                ...
                                <p><strong>Date :</strong> {appointment.preferred_date ? formatDate(appointment.preferred_date) : 'Non définie'}</p>
